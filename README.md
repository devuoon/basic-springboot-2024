...
- Tip
  ...
  - Spring Boot JPA 프로젝트 개발 계속
    ...
    17. (문제) 각 입력창에 공백을 넣었을 때 입력되는 문제 @NotEmpty는 스페이스를 허용 -> @NotBlank로 변경
      <img src="https://raw.githubusercontent.com/devuoon/basic-springboot-2024/main/images/sp005.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
  ...
  1.  페이징
    ...
    - /template/board/list.html에 게시글 번호 수정
      <img src="https://raw.githubusercontent.com/devuoon/basic-springboot-2024/main/images/sp006.png" width="730">
  ...
  ## 8일차
    - Spring Boot JPA 프로젝트 개발 계속
      1. 스프링 시큐리티 계속
        - /security/SecurityConfig.java에 BCryptPassowrdEncoder를 빈으로 작업
        ...
        - /template/member/register.html 생성
    ...
    ## 9일차
      - Spring Boot JPA 프로젝트 개발 계속
        1. 수정, 삭제
          ...
          - /template/board/create.html th:action을 삭제
    ...
    - Spring Boot JPA 프로젝트 개발 계속
      1. 검색 기능 - JPA Query
        ...
        - /repository/BoardRepository.java findAllKeyword() 메서드 추가
        - JPA Query @Query("")에 작성
        - /service/BoardService.java getList() 수정

      2. 마크다운 적용
        - Wysiwyg 에디터 - CKEditor(https://ckeditor.com/), TinyMCE
        - simpemde(https://simplemde.com/) 깃험에 CDN 링크 복사 layout.html 링크추가
...
- Spring Boot JPA 프로젝트 개발 계속
	...
	<img src="https://raw.githubusercontent.com/devuoon/basic-springboot-2024/main/images/sp011.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
	...
	2. 비밀번호 초기화
		...
		- 네이버 메일 SMTP 설정 > 환경설정 > POP3/IMAP 설정
			...
			<img src="https://raw.githubusercontent.com/devuoon/basic-springboot-2024/main/images/sp012.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
  0. 메일작업 중 생긴 오류
    ...
    - /controller/MailController.java 생성. /mail/reset-mail GET매핑
    - /service/MemberService.java에 메일주소로 검색하는 메서드 추가
    - /service/MailService.java에 메일전송 메서드 생성, 수정 
      - UUID를 생성해서 메일로 전송하는 기능 추가

        <img src="https://raw.githubusercontent.com/devuoon/basic-springboot-2024/main/images/sp013.png" width="730">
    ...
    - /controller/MailController.java, /mail/reset-password Get 메서드 작성
    - /templates/member/newpassowrd.html 생성
    - /controller/MemberController.java, /member/reset-password Post 메서드 작성
    - /service/MemberService.java에 setMember() 메서드 추가

      <img src="https://raw.githubusercontent.com/devuoon/basic-springboot-2024/main/images/sp014.png" width="730">
